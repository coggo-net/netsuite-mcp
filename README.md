...
| **Vendor Bill** | vendor_bill_list, vendor_bill_get, vendor_bill_search, vendor_bill_get_overdue, vendor_bill_create, vendor_bill_create_from_po, vendor_bill_update, vendor_bill_delete |
