...
const RECORD_TYPE = "subsidiary";

export function registerSubsidiaryAPI(client: NetSuiteClient) {
	return {
		...
		search(keyword: string, params: Omit<ListParams, "q"> = {}) {
			return client.listRecords(RECORD_TYPE, {
				...params,
				q: `name CONTAIN "${keyword}"`,
			});
		},
	};
}

export type SubsidiaryAPI = ReturnType<typeof registerSubsidiaryAPI>;
