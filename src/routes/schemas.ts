...
export const customerBody = z.object({
	companyName: z.string().optional().describe("Legal company name (required for company customers)"),
	isPerson: z.boolean().optional().describe("true for individual, false for company"),
	firstName: z.string().optional().describe("First name (required if isPerson)"),
	lastName: z.string().optional().describe("Last name (required if isPerson)"),
	email: z.string().optional().describe("Primary email address"),
	phone: z.string().optional().describe("Primary phone number"),
	entityId: z.string().optional().describe("Customer ID/number (auto-generated if omitted)"),
	...
	isInactive: z.boolean().optional().describe("Inactive flag (defaults to false)"),
...
export const inventoryItemBody = z.object({
	...
	purchaseDescription: z.string().optional().describe("Description on purchase orders"),
	salesDescription: z.string().optional().describe("Description on sales transactions"),
...
export const inventoryAdjustmentBody = z.object({
	...
	inventory: z.object({ items: z.array(adjustmentLineItem) }).describe("Adjustment lines"),
}).describe("Inventory adjustment");

export const inventoryTransferBody = z.object({
	subsidiary: nsRef.describe("Subsidiary"),
	...
	inventory: z.object({ items: z.array(transferLineItem) }).describe("Transfer lines"),
}).describe("Inventory transfer");

export const salesOrderBody = z.object({
	...
	customForm: nsRef.optional().describe("Custom form (use PI form for Pro-Forma Invoices)"),
...
export const purchaseOrderBody = z.object({
	...
	dueDate: z.string().optional().describe("Expected delivery date (YYYY-MM-DD)"),
...
export const itemReceiptBody = z.object({
	...
	item: z.object({ items: z.array(receiptLineItem) }).optional().describe("Receipt lines"),
